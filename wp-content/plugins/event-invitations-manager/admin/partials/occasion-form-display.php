...
if ( isset( $_POST['submit'] ) && check_admin_referer( 'eim_save_occasion_action', 'eim_save_occasion_nonce' ) ) {
    ...
    if ( $is_edit_mode ) {
        ...
        $message = 'تمت إضافة المناسبة بنجاح!';
    }
...
<form method="post">
    ...
    <table class="form-table">
        <tbody>
            <tr>
                <th scope="row"><label for="name">اسم المناسبة</label></th>
                <td><input type="text" name="name" id="name" value="<?php echo esc_attr( $occasion['name'] ); ?>" class="regular-text" required></td>
            </tr>
            <tr>
                <th scope="row"><label for="event_date">تاريخ المناسبة</label></th>
            ...
            <tr>
                <th scope="row"><label for="welcome_message">رسالة الترحيب</label></th>
             ...
             <tr>
                <th scope="row"><label for="invitation_image">رابط صورة الدعوة</label></th>
                <td>
                    ...
                    <button type="button" class="button" id="upload_image_button">رفع صورة</button>
                    <p class="description">ارفع أو اختر صورة من مكتبة الوسائط.</p>
                </td>
            </tr>
             <tr>
                <th scope="row"><label for="venue_details">تفاصيل المكان</label></th>
            ...
            <tr>
                <th scope="row"><label for="time_details">تفاصيل الوقت</label></th>
            ...
            <tr>
                <th scope="row"><label for="location_details">تفاصيل الموقع (رابط خرائط جوجل)</label></th>
    ...
    <?php submit_button( $is_edit_mode ? 'تحديث المناسبة' : 'إضافة مناسبة' ); ?>
</form>
